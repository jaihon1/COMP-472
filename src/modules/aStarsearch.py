...
class AStarSearch():
    ...
    # push to the end of the open list and sort
    ...
    def run(self, board):
        ...
        while self.getOpenList():
            ...
            if result:
                ...
                print("--- Duration of A*: %s seconds ---" % (time.time() - start_time))
                ...
                for child in children:
                    ...
                    print(child.getAlphabeticalCoordinateI(), child.getCoordinateJ())
